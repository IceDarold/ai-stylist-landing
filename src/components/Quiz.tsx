  ...
  const renderStep = () => {
    switch (stepId) {
        ...
        return (
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="mb-2 block text-sm">Рост (см)</label>
                <input
                  type="number"
                  min={150}
                  max={210}
              ...
              <div>
                <label className="mb-2 block text-sm">Вес (кг)</label>
                <input
                  type="number"
                  min={45}
                  max={160}
      ...
      case "size_fit":
        return (
          <div>
            <h2 className="mb-6 text-xl font-semibold">Размеры и посадка</h2>
            <div className="space-y-4">
              <div>
                <label className="mb-2 block text-sm">Размер верха (RU)</label>
                <select
                  className="input w-full"
                  value={data.top_size ?? ""}
              ...
              <div>
                <label className="mb-2 block text-sm">Талия</label>
                <input
                  type="number"
                  className="input w-full"
              ...
              <div>
                <label className="mb-2 block text-sm">Длина низа</label>
                <input
                  type="number"
                  className="input w-full"
              ...
              <div>
                <label className="mb-2 block text-sm">Посадка верха</label>
                <select
                  className="input w-full"
              ...
              <div>
                <label className="mb-2 block text-sm">Посадка низа</label>
                <select
                  className="input w-full"
            ...
            <p className="mt-2 text-xs text-gray-500">
              Не уверены в параметрах? Не переживайте — наш ИИ подберёт их автоматически.
            </p>
          </div>
        );
      case "shoe_ru":
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
        <div className="max-h-full w-full max-w-lg overflow-auto rounded-xl bg-white p-6 text-center shadow-lg">
          ...
          <p className="mb-6 text-black/70">Мы получили ваши ответы и уже подбираем 3 лука.</p>
