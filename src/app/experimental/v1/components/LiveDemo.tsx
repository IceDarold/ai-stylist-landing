        ...
        <div className="flex justify-center space-x-2 md:space-x-4 mb-12">
          {occasions.map((occasion) => (
            <button
              ...
              className={`px-4 py-2 text-sm md:px-6 md:py-3 md:text-base rounded-full transition-colors font-semibold ${
                activeOccasion === occasion ? 'bg-green-400 text-gray-900' : 'bg-white/10 hover:bg-white/20'
              }`}
            >
              {occasion}
            </button>
