...
const steps = [
  {
    ...
    description:
      'Upload a photo or enter your parameters (height, weight, style preferences). Your profile is saved for a personalized experience every time.',
  },
  {
    icon: Sparkles,
    title: 'AI-Powered Curation',
    description:
      'Our AI stylist analyzes your data and scours thousands of products to find the perfect items for you, considering fit, quality, and budget.',
  },
  {
    icon: ShoppingBag,
    title: 'Shop Your Look',
    description:
      'Receive complete, ready-to-wear outfits. Mix and match items, or buy a curated look directly from our partner stores.',
  },
];
