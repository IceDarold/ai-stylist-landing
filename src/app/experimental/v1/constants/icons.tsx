...
export const TwitterIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616v.064c0 2.298 1.634 4.212 3.793 4.649-.65.177-1.354.238-2.058.159.601 1.948 2.345 3.364 4.414 3.404-1.621 1.274-3.666 2.031-5.89 1.745 1.693 1.093 3.714 1.734 5.86 1.734 7.03 0 10.875-5.834 10.875-10.875 0-.165-.004-.33-.011-.494.747-.538 1.393-1.213 1.905-1.964z" />
    </svg>
);

export const WifiIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.111 16.556A5.5 5.5 0 0112 15c1.472 0 2.822.55 3.889 1.556M4.889 13.111A9.5 9.5 0 0112 11c3.276 0 6.222.99 8.111 2.111m-14.222-6.222a13.5 13.5 0 0112.444 0" />
  </svg>
);

export const CellularIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M21 4H18V20H21V4ZM4 12H7V20H4V12ZM14.5 8H11.5V20H14.5V8ZM11 7H8V20H11V7Z" />
  </svg>
);
